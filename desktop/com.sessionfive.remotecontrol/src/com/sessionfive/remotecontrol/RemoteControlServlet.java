...
public class RemoteControlServlet extends HttpServlet {
	...
	private void returnKeyFrameAt(HttpServletRequest request,
			HttpServletResponse response) throws IOException {
		String keyFrameNo = request.getParameter("at");
		if (keyFrameNo != null) {
			int parsedNumber = Integer.parseInt(keyFrameNo);
			if (parsedNumber < SessionFiveApplication.getInstance().getAnimationController().getNumberOfKeyFrames()) {
	...
	private void returnNumberOfKeyFrames(HttpServletRequest request,
			HttpServletResponse response) throws IOException {
		int numberOfKeyFrames = SessionFiveApplication.getInstance().getAnimationController().getNumberOfKeyFrames();
	...
	private void returnImages(HttpServletRequest request,
